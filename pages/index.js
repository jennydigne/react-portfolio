...
export default function Home() {
  ...
  return (
    <div className="w-screen flex flex-col min-h-screen">
        ...
        <div className="mb-12 mt-20">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-8 mx-8 lg:mx-12 auto-rows-fr">
            {(projects ?? []).map((project, index) => (
              <div key={index} className="shadow-md hover:shadow-lg transition-shadow h-full max-h-[400px] rounded-lg overflow-hidden flex flex-col mb-4 bg-white">
      ...
      <footer className="bg-gradient-to-b from-slate-200 to-white w-full h-20 flex relative bottom-0 items-center justify-around">
